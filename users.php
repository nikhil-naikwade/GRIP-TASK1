    ...
    if (($amount)<0)
   {
    ...
    //For 0 (zero) value
         ...
         echo "</script>";
                ...
                $dt=date("d M Y h:m:s a", time());
                echo $dt;
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = "INSERT INTO transaction(`sender`, `receiver`, `amount`,`date`) VALUES ('$sender','$receiver','$amount','$dt')";
                $query=mysqli_query($conn,$sql);
   ...
   <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: grey;text-align:center;color:white;">
                © 2021 Copyright - Made by <strong>Nikhil Shriram Naikwade</strong> :
                <a class="text-dark" href="https://www.thesparksfoundationsingapore.org/" target="_blank" style="color:white;"> The Spark Foundation Intern Batch - December 2021</a>
            </div>
            <!-- Copyright -->
        </footer>
